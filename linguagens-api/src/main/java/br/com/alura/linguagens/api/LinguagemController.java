...
public class LinguagemController {
    ...
    @GetMapping ("/linguagens") public List<Linguagem> obterLinguagens () {
    ...
    @PutMapping("/linguagens/{id}") public Linguagem atualizarLinguagem (@PathVariable String id, @RequestBody Linguagem linguagem) {
    ...
    @DeleteMapping("/linguagens/{id}") public void excluirLinguagem(@PathVariable String id) {
